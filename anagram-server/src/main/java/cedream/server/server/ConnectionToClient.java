...
import cedream.server.model.Facade;
import cedream.server.model.Model;
import java.io.*;
import java.net.*;
import java.util.*;
...
public class ConnectionToClient extends Thread {
    ...
    protected ConnectionToClient(Socket clientSocket,
        ...
        try {
            anagram.initialize();
            anagram.start();
            scrambledWord = anagram.nextWord();
    ...
    public void setScrambledWord(String word) {
